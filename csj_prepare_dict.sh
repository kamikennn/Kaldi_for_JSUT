...
# Making dictionary using JSUT data with morpheme analysis.
...
mkdir -p $dir
srcdict=data/lexicon/lexicon.txt
...
echo Prepared input dictionary and phone-sets for JSUT phase 1.
